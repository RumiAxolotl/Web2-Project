...
<div style="border:2px solid #b55b00; width:500px;height:250px;
    ...
    box-shadow: 4px 3px 8px 1px #969696;border-radius: 10px;">
        ...
        <div style="margin:10px;">
            ...
            <select name="theloai" id="theloai1" style="height:34px;width:37%;">  
        ...
        <br>
        <label for="" style="font-size:24px;margin:2px;">Khoảng giá</label>
        <br>
        <label for="" style="font-size:24px;margin:10px;">Từ</label>
        <input type="number" value="100" placeholder="From" id="from1" name="from" style="height:24px;">
        <br>
        <label for="" style="font-size:24px;margin:2px;">Đến</label>
        <input type="number" id="to1" value="2000000" placeholder="To" name="to" style="height:24px;"><br>
        <button onclick="locnangcao()" style="box-shadow: 4px 3px 8px 1px #4a4a4a;
        background-color:#1a9900;border:0;border-radius:10px;
        color:white;height:50px;width:200px;margin-top:2px;
