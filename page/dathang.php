   ...
   if(isset($_POST['tenkh']) && !empty($_POST['tenkh']) && isset($_POST['diachi']) && !empty($_POST['diachi']) && isset($_POST['sdt']) && !empty($_POST['sdt'])){
      ...
      // $id_customer = $_SESSION['id'];
       ...
       $total_money = $_SESSION['tonghoadon'][0];
        $sql= "INSERT INTO `tbl_order`(`id_customer`, `ten_kh`, `ngay_dat`, `address`, `phone`, `status`, `notes`, `total_money`) VALUES ('$id_customer','$name',".time().",'$diachi','$sdt','0','$note','$total_money')";
