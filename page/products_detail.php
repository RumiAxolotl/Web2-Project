        ...
        <div class="row">
            <div class="col-2">
                <div class = "product-imgs" style="flex-direction: column; justify-content: center;">
                    ...
                    <a href = "#" data-id = "2" >
                            <img id="img-item-2" src = "./admin/images/<?=$row['image2']?>" alt = "shoe image">
                        </a>
                    </div>
                    <div class = "img-item" style="margin: 0.1rem;margin-right: 0;">
                    <a href = "#" data-id = "3">
                <img id="img-item-3" src = "./admin/images/<?=$row['image3']?>" alt = "shoe image">
                </a>
            </div>
            <div class = "img-item">
              <a href = "#" data-id = "4" style="margin: 0.1rem;">
                <img id="img-item-4" src = "./admin/images/<?=$row['image4']?>" alt = "shoe image">
              </a>
            </div>
          </div>
        </div>
